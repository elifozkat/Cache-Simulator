...
public class CacheLRU {
		...
		int associativity;					//CacheLRU has these properties.
		int cache_size;
		int block_size;
		Set[] sets;
		...
		public CacheLRU(int associativity, int cache_size, int block_size, String filename, String logFileName, int recency){
			...
			try {
				...
				while((line = in.readLine()) != null)
				{
					...
					if(lineCounter%5==0){										//If the count of line is multiple of 5
						switch (sets[indexOfSet].writeLRU(tagOfBlock)) {		//we perform a write operation for that line.
						...
						case 1:													//We perform this operation by applying the LRU policy.
							numOfMisses++;
						...
						switch (sets[indexOfSet].readLRU(tagOfBlock)) {				//If the count of line is not multiple of 5,
